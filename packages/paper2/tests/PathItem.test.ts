...
import { Path, PathItem } from '~/index-core';
import { equals } from './_helpers';

describe('Given: PathItem', () => {
  it('PathItem#create() with SVG path-data (#1101)', () => {
    const data = [
      ...
      'M210 130C145 130 110 80 110 80S75 25 10 25m0 105c65 0 100 -50 100 ' + '-50s35 -55 100 -55',
      'M240 90c0 30 7 50 50 0c43-50 50 -30 50 0c0 83-68-34-90-30C240 60 ' + '240 90 240 90z',
    ...
    const expected = [
      [
        [[11, 18], [11, 6], [2.5, 12], true],
        [[11.5, 12], [20, 18], [20, 6], true],
      ],
      [
        [[20, 20], [40, 40], [40, 20], true],
        [[40, 40], [20, 60], [40, 60], true],
      ],
      [
        [[11, 18], [11, 6], [2.5, 12], true],
        [[11.5, 12], [20, 18], [20, 6], true],
      ...
      [[240, 90, 0, 0, 0, 30], [290, 90, -43, 50, 43, -50], [340, 90, 0, -30, 0, 83], [250, 60, 22, -4, -10, 0], true],
      ...
      [
        [
          [15, 20, 0, 0, 10, 66.66667],
          [130, 30, -66.66667, 60, 0, 0],
        ],
      ...
      [
        ...
        [258, 118, 66.66667, -33.33333, -86.66667, -20],
        true,
      ],
      [[60, 100, 66.66667, 33.33333, -66.66667, 33.33333], [60, 200, -66.66667, -33.33333, 66.66667, -33.33333], true],
      [
    ...
    // function describeIt(path) {
    //   let res;
    //   if (path.children) {
    //     res = path.children.map(function (child) {
    //       return describeIt(child);
    //     });
    //   } else {
    ...
    //       return (hi.isZero() && ho.isZero() ? [pt.x, pt.y] : [pt.x, pt.y, hi.x, hi.y, ho.x, ho.y]).map(function (x) {
    //         return Math.round(x * multiplier) / multiplier;
    //       });
    //     });
    //     if (path.closed) res.push(true);
    //   }
    //   return res;
    // }

    data.forEach(function (entry, i) {
      const path = PathItem.create(entry);
      // console.log(JSON.stringify(describeIt(path)));
  ...
  it('PathItem#compare()', () => {
    ...
    equals(
      ...
      false,
      'Comparing with an invalid item should return false.'
    );
    equals(
      function () {
      ...
      false,
      'Comparing a square with an empty path should return false.'
    );
    equals(
      function () {
      ...
      false,
      'Comparing a square with a circle should return false.'
    );
    equals(
      function () {
      ...
      true,
      'Comparing a square with its clone should return true.'
    );
    equals(
      function () {
      ...
      true,
      'Comparing a circle with its clone should return true.'
    );
    equals(
      function () {
      ...
      true,
      'Comparing a square with an identical square with additional segments should return true.'
    );
    equals(
      function () {
      ...
      true,
      'Comparing a square with additional segments with an identical square should return true.'
    );
    equals(
      function () {
      ...
      true,
      'Comparing a circle with an identical circle with additional segments should return true.'
    );
    equals(
      function () {
      ...
      true,
      'Comparing a circle with additional segments with an identical circle should return true.'
    );

    const compoundPath1 = PathItem.create('M50,300l0,-150l50,25l0,-75l200,0l0,200z M100,200l50,0l-50,-25z');
    const compoundPath2 = PathItem.create('M50,300l0,-150l50,25l0,-75l200,0l0,200z M100,175l0,25l50,0z');
    const compoundPath3 = PathItem.create('M50,300l0,-150l50,25l0,-75l200,0l0,210z M100,200l50,0l-50,-25z');
    ...
    equals(
      ...
      true,
      'Comparing two compound paths with one child starting at a different point should return true.'
    );
    equals(
      function () {
      ...
      false,
      'Comparing two compound paths with one child having a different shape should return false.'
    );
  });
});
