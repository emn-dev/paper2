...
import { paper, Path, PathItem, Point, CompoundPath, Color } from '~/index-core';
import { compareBoolean, equals } from './_helpers';
...
describe('Given: Path Boolean Operations', () => {
  ...
  it('#839', () => {
    ...
    const p2 = new Path.Rectangle(250, 300, 100, 200);
    compareBoolean(function () {
      return p1.subtract(p2);
  ...
  it('#865', () => {
    function executeTest(offset) {
      ...
      compareBoolean(p1.subtract(p2), 'M300,100l0,250l-44,0l0,-250z', 'p1.subtract(p2); // with offset = ' + offset);
    }
  ...
  it('#870', () => {
    ...
    const path1b = new Path.Rectangle({
      point: [50, 150],
      size: [50, 100],
    });

    const path2b = new Path.Rectangle({
      point: [50, 175],
      size: [50, 100],
    });

    compareBoolean(function () {
      return path1b.intersect(path2b);
  ...
  it('#875', () => {
    ...
    const p2 = new Path.Circle(260, 320, 100);
  ...
  it('#878', () => {
    const p1 = new Path({
      segments: [
        ...
        [128.00000000000003, 370],
        [80.00000000000003, 479.99999999999994],
      ],
      closed: true,
    });
    const p2 = new Path({
  ...
  it('#889', () => {
    ...
    const p = new Path({
      segments: [
        ...
        [637, 704],
        [205, 704],
        [204.30709922574619, 356.553500194953],
      ],
      closed: true,
    });
    compareBoolean(function () {
  ...
  it('#890', () => {
    ...
    const cp2 = new CompoundPath([
      new Path({
        segments: [
          [576, 396.8],
          [345.78, 396.8],
          [249.6, 243.20000000000002],
        ],
        closed: true,
      }),
      new Path({
    ...
    const p2 = new Path({
      segments: [
        [323.0000000000002, 228.0000000000001, 0, 0, 51.95879291356505, 0],
        [410.9999999999998, 704.0000000000002],
        [-21.000000000000227, 703.9999999999998],
        [-21.692900774253758, 356.5535001949528],
      ],
      closed: true,
    });
    compareBoolean(function () {
      return cp2.subtract(p2);
  ...
  it('#899', () => {
    const path = new Path({
      segments: [
        [349.31714952528665, 176.97192499841802, 2.0667935742653185, -10.850610233997372, 0, 0],
        [308.23418424120047, 394.39737504104323, 0, 0, -0.3852007263769224, 2.0386172397749647],
        [273.60284923271973, 415.7138856106701, 9.194683617471242, 1.7373535056759692, 0, 0],
        [
          340.6967045975081, 152.3115389894092, -4.006231967752797, -3.6687868382265094, 5.694026309937783,
          5.214418174126138,
        ],
        [
          349.72123243229134, 170.85618880187394, -0.36146393999291604, -6.612268801346318, 0.1110858449889065,
          2.0320961120115726,
        ],
        [
          349.31714952528654, 176.97192499841861, 0.3852007263769224, -2.038617239775249, -2.0667935742656027,
          10.850610233997315,
        ],
        [
          333.4126425432937, 153.58289639999975, -10.850610233997315, -2.0667935742653754, 10.850610233997372,
          2.0667935742653754,
        ],
      ],
      closed: true,
  ...
  it('#923', () => {
    const p1 = new Path.Circle({ center: [100, 100], radius: 20 });
    const p2 = new Path.Circle({ center: [150, 100], radius: 20 });
    const cp = new CompoundPath([p1, p2]);
    const p3 = new Path.Circle({ center: [100, 100], radius: 20 });
    // cp.strokeColor = 'red';
    cp.strokeColor = new Color(1, 0, 0);
    // p3.strokeColor = 'green';
    p3.strokeColor = new Color(0, 1, 0);
  ...
  it('#958', () => {
    const p1 = new Path.Rectangle(100, 200, 200, 20);
    const p2 = new Path.Rectangle(140, 100, 20, 20);
    const cp = new CompoundPath({ children: [p1, p2] });
    const bounds = new Path.Rectangle(cp.bounds);
    compareBoolean(function () {
      return bounds.intersect(cp);
  ...
  it('#973', () => {
    const path = new Path.Ellipse(100, 100, 150, 110);
    path.segments[1].point.y += 60;
    path.segments[3].point.y -= 60;

    const resolved = path.resolveCrossings();
    const orientation = resolved.children.map(function (child) {
      return child.isClockwise();
    });
    equals(orientation, [true, false, true], 'children orientation after calling path.resolveCrossings()');
  });
  ...
  it('#1091', () => {
    ...
    let res = new CompoundPath();

    for (let i = 0; i < data.length; i++) {
      const path = PathItem.create(data[i]);
      path.remove();
      const prev = res;
      res = res.unite(path);
      prev.remove();
  ...
  it('#1109', () => {
    ...
    const p3 = new paper.CompoundPath([
      new Path.Rectangle(210, 110, 180, 180),
      new Path({ segments: segments, closed: true }),
    ]);

    // Add a little spike, see #issuecomment-236026445
    segments.splice(3, 0, [260.5870762798793, 200], [265.5870762798793, 201], [260.5870762798793, 202]);
    const p4 = new paper.CompoundPath([
      new Path.Rectangle(210, 110, 180, 180),
      new Path({ segments: segments, closed: true }),
    ]);
  ...
  it('#1123', () => {
    ...
    const p2 = new paper.Path({
      segments: [
        [
          // eslint-disable-next-line no-loss-of-precision
          5.684341886080802e-14, 132.07000000000002, 12.910000000000025, 27.075000000000017, 21.125,
          -21.119999999999976,
        ],
  ...
  it('#1123 b', () => {
    const p1 = new Path.Rectangle(100, 100, 100, 100);
    const p2 = new Path.Rectangle(120, 120, 60, 60);
    compareBoolean(function () {
      return p1.subtract(p2).subtract(p2);
  ...
  it('#1221', () => {
    ...
    compareBoolean(function () {
      return rect1.subtract(circle, { trace: false });
    }, 'M200,100h100v200h-200v-100');
    compareBoolean(function () {
      return rect1.subtract(circle, { trace: true });
    }, 'M100,300v-100c55.22847,0 100,-44.77153 100,-100h100v200z');

    const blob = PathItem.create(
      'M534,273C171.7,111,60.5,117.1,30,158c-40.5,54.3,31.5,210.2,111,222c60.8,9,88-71.9,159-66c81.6,6.8,99.6,118.3,179,128c33.8,4.1,83.1-9.7,150-90'
    );
    ...
    compareBoolean(function () {
      return blob.subtract(rect2, { trace: false });
    ...
    compareBoolean(function () {
      return blob.subtract(rect2, { trace: true });
    ...
    const rect3 = new Path.Rectangle({
      point: [150, 100],
      size: [300, 150],
    });

    compareBoolean(function () {
      return blob.subtract(rect3, { trace: false });
    ...
    compareBoolean(function () {
      return blob.subtract(rect3, { trace: true });
    ...
    const rect4 = new Path.Rectangle({
      point: [200, 200],
      size: [400, 200],
    });
    ...
    const division = line.divide(rect4, { trace: false });
    equals(function () {
      return division.children.length;
    }, 2);
    compareBoolean(function () {
      return division.children[0];
    }, 'M400,300v100');
    compareBoolean(function () {
      return division.children[1];
    }, 'M400,400v200');
  });
  ...
  it('#1261', () => {
    const p1 = PathItem.create('M933.13,1023.97l-516.19,-171.71l607.1,-101.57z');
    const p2 = PathItem.create(
      'M933.13,1023.97l-516.19,-171.71l67.33,-11.27l337.49,112.27c16.7,-50.22 71.03,-77.36 121.34,-60.63l45.23,-135.96l35.71,-5.98z'
    );
  ...
  it("Selected edge-cases from @hari's boolean-test suite", () => {
    ...
    const t = PathItem.create(
      'M283.8,165.2L283.8,227.2L248.6,227.2L248.6,257.2L283.8,257.2L283.8,388.8Q283.8,403.2,286.6,412Q289.4,420.8,295.2,425.6Q301,430.4,310.4,432.2Q319.8,434,333,434L359,434L359,404L343.4,404Q335.4,404,330.4,403.4Q325.4,402.8,322.6,400.8Q319.8,398.8,318.8,395.2Q317.8,391.6,317.8,385.6L317.8,257.2L359,257.2L359,227.2L317.8,227.2L317.8,165.2Z'
    );
    const k = PathItem.create(
      'M402.62,200.96L193.81,395.8L217,420.66L274.33,367.18L317.8,370.38L287.14,495.82L316.61,527.41L352.79,373.29L463.72,381.94L463.72,381.94L432.61,348.6L302.11,341.25L425.82,225.82L402.62,200.96Z'
    );
    compareBoolean(function () {
      return t.unite(k);
    ...
    const t2 = PathItem.create(
      'M283.8,165.2L283.8,227.2L248.6,227.2L248.6,257.2L283.8,257.2L283.8,388.8Q283.8,403.2,286.6,412Q289.4,420.8,295.2,425.6Q301,430.4,310.4,432.2Q319.8,434,333,434L359,434L359,404L343.4,404Q335.4,404,330.4,403.4Q325.4,402.8,322.6,400.8Q319.8,398.8,318.8,395.2Q317.8,391.6,317.8,385.6L317.8,257.2L359,257.2L359,227.2L317.8,227.2L317.8,165.2Z'
    );
    const r = PathItem.create(
  ...
  it('Selected test-cases provided by @iconexperience', () => {
    ...
    const paths = [
      [
        [
          [
            276.60479999999995, 265.6776, 2.6464000000000283, 5.646400000000028, 1.2208000000000538,
            -0.8512000000000057,
          ],
          [279.9632, 262.924, -1.0127999999999702, 1.0160000000000196, 0.019200000000012096, 3.302400000000034],
          [294.4, 269.31440000000003, -7.240000000000009, 0, 7.240000000000009, 0],
          [308.8384, 262.924, -0.020800000000008367, 3.302400000000034, 1.0112000000000307, 1.0160000000000196],
          [312.1968, 265.6776, -1.2224000000000501, -0.8512000000000057, -2.6464000000000283, 5.646400000000028],
          [294.4, 273.3128, 5.590400000000045, 0, -5.590399999999988, 0],
          true,
        ],
        [
          [294.4, 273.3128, 0, 0, -7.240000000000009, 0],
          [279.9808, 266.9064, 0.014400000000023283, 3.3023999999999774, 0, 0],
          [279.91999999999996, 253.31279999999998, 0, 0, 9.652800000000013, 0],
          [308.88, 253.31279999999998, -9.652800000000013, 0, 0, 0],
          [308.82079999999996, 266.9064, 0, 0, -0.014865740466348143, 3.068288832262283],
          [
            295.93610344888236, 273.2670371105283, 6.683812628997487, -0.3953268817066373, 5.682599074647953,
            -0.3268447810676207,
          ],
          [312.1968, 265.6776, -2.4122653499520084, 5.146166079897625, 8.40640000000002, 5.8559999999999945],
          [294.4, 307.1864, 16, 0.001599999999996271, 0, 0],
          true,
        ],
      ],
      [
        [
          [512, 563.0515712, 0, 0, 0, 0],
          [462.4499456000001, 563.0515712, 0, 0, -3.031499856000039, 0],
          [456.94438400000007, 557.549450576, 0, 3.031499855999982, 0, 0],
          true,
        ],
        [
          [462.4499456000001, 563.0515712, -3.031499856000039, 0, -3.0303527841790014, 0],
          [456.94438506256495, 557.5494505759262, 0.0018713092763391614, 3.0299308178812225, 0, 0],
          [567.0556160000001, 564],
          true,
        ],
      ],
      [
        [
          [506.49443840000004, 600, 0, 0, 0, 0],
          [567.0556160000001, 623.6127488, 0, 0, 0, 3.031499856000096],
          [561.5500544, 629.1148694240001, 3.031499855999982, 0, 3.031499855999982, 0],
          [567.0556160000001, 634.620431024, 0, -3.031499855999982, 0, 0],
          true,
        ],
        [
          [561.5500544, 629.1148694240001, 3.031499855999982, 0, 3.031499855999982, 0],
          [567.0556160000001, 634.620431024, 0, -3.0280588800000032, 0, 0],
          [567.0556160000001, 656.6461184, 0, 0, 0, 3.0280588800000032],
          true,
        ],
      ],
      [
        [
          [
            400.81546878700505, 400.81546878700505, 79.97937495065997, -79.9793749506602, -79.97937495066014,
            79.97937495065997,
          ],
          [
            111.18453121299513, 400.81546878700505, 79.97937495066012, 79.97937495065997, -79.97937495066009,
            -79.9793749506602,
          ],
          [
            111.18453121299507, 111.18453121299507, -79.97937495066003, 79.97937495066017, 79.97937495066009,
            -79.97937495066007,
          ],
          [
            400.815468787005, 111.18453121299503, -79.97937495066009, -79.97937495066003, 79.97937495066003,
            79.97937495066007,
          ],
          true,
        ],
        [
          [
            400.815468787005, 400.815468787005, 79.97937495065997, -79.97937495066014, -79.97937495066014,
            79.97937495065992,
          ],
          [
            111.18453121299507, 400.815468787005, 79.97937495066014, 79.97937495065992, -79.97937495066003,
            -79.9793749506602,
          ],
          [
            111.18453121299507, 111.18453121299504, -79.97937495066003, 79.97937495066014, 79.97937495066009,
            -79.97937495066006,
          ],
          [
            400.81546878700493, 111.184531212995, -79.97937495066009, -79.97937495066002, 79.97937495066003,
            79.97937495066004,
          ],
          true,
        ],
      ...
      [
        [
          [512, 96, -125.89361307431193, 0, 168, 0],
          [736, 337.78, 0, -120.88999999999999, 0, 21.79000000000002],
          [729.34, 402.7, 4.319999999999936, -21.340000000000032, -25.649999999999977, 126.62999999999994],
          [512, 640, 95.85000000000002, 0, 0, 0],
          [
            288.04, 332.0799999999999, 100.000575152844760396, -0.000053268689669039304, 0.41767160812742077,
            -28.392122573051836,
          ],
          [
            299.43514767699014, 248.78534185388617, -7.421136238632187, 26.615225151165646, 23.67264213867054,
            -84.8997620019185,
          ],
          true,
        ],
        [
          [512, 96, -125.89322163652065, 0, 168, 0],
          [736, 337.78, 0, -120.88999999999999, 0, 151.11],
          [512, 640, 112, 0, -112, 0],
          [288, 337.78, 0, 151.11, 0, -1.9002097681526493],
          [
            288.04172546304807, 332.07984018287976, -0.02788946906741785, 1.8997402808149104, 0.4168153242491144,
            -28.39210955294908,
          ],
          [
            299.4351476773096, 248.7853418527407, -7.42079681324509, 26.615144268685953, 23.671675930689275,
            -84.89992191301803,
          ],
          true,
        ],
  ...
  it("Isolated edge-cases from @iconexperience's boolean-test suite", () => {
    ...
    const paths = [
      [
        [
          [240, 270],
          [250.53466323186618, 221.0057178821544],
          [237.67824477332854, 193.79795691566554],
          [320, 240],
          true,
        ],
      ...
      [
        ...
        [
          ...
          [329.00715661950534, 214.6369961279195],
          true,
        ],
      ],
      [
        [
          ...
          [142.17355611649077, 367.3087985311291],
          true,
        ],
        [
          [152.06363005021922, 397.5347520600572],
      ...
      [
        [
          ...
          [147.64340975918196, 340.17263448268653],
          true,
        ],
        [
          [102.88355437423151, 307.6462971693936],
      ...
      [
        [
          [260.5630488345416, 240.11728335016855],
          [230.82205831331396, 236.1805613638536],
          [300.041224753361, 200],
          [300, 300],
          true,
        ],
      ...
      [
        [
          [266.2339624919457, 249.28592706878334],
          [236.42561910533144, 245.88969337410168],
          [320, 240],
          [280, 300],
          true,
        ],
      ...
      [
        [
          [109.2693308633721, 249.31916869409733],
          [157.6368865573791, 284.8238100271277],
          [150, 329.3972954455561],
          true,
        ],
        [
          [109.26933086337212, 249.3191686940973],
          [157.1468245594682, 224.11329044817836],
      ...
      [
        [
          ...
          [197.1892333604494, 233.7404268430289],
          true,
        ],
        [
          ...
          [197.18923336044946, 233.74042684302884],
          true,
        ],
      ],
      [
        [
          ...
          [384.95409529898944, 237.01272999645926],
          [350, 300],
          true,
        ],
      ...
      [
        [
          ...
          [287.7087867546365, 246.8036908431129],
          true,
        ],
        [
          [267.0542186716473, 253.4830551491999],
      ...
      [
        ...
        [
          ...
          [487.8821067425946, 340.2688405948006],
          [529.4025393039343, 348.4286400051758, 0, 0, -0.93900751246872, -2.1407484665217567],
          true,
        ],
        [
          [475.5403232814915, 337.8433726698194],
          [538.3223483008236, 152.20174200302918],
      ...
      [
        [
          [100.10301277238074, 299.8360064274938],
          [192.98476439737567, 381.03840618337944],
        ...
        [
          [195.00176127688619, 345.64254151310115],
          [481.252611684097, 441.78388187198607],
      ...
      [
        [
          [201.4099970302107, 456.883477028569],
        ...
        [
          [166.32133819059692, 458.01301981440685],
          [204.6120898437701, 320.4482218772343],
      ...
      [
        [
          ...
          [135.69748583246292, 231.99189079590533],
          true,
        ],
        [
          [248.04309709886002, 178.55347910623016],
      ...
      [
        [
          ...
          [545.7583411018326, 213.0016798561104],
      ...
      [
        [
          [290.1253327484206, 287.90652074109494],
          [342.6480156335393, 281.88796157138086],
          [340.20645047153664, 251.98747653472907],
          [370.8816252545162, 292.03012917196776],
          true,
        ],
        [
          [345.08958029318296, 311.78843842619824],
          [300.0082518321038, 300.98900280805503],
          [340.20645030689445, 251.98747654817316],
          true,
        ],
      ],
      [
      ...
      [
        [
          ...
          [357.2674295740252, 218.16254181654907],
          true,
        ],
        [
          ...
          [357.26742957402513, 218.16254181654915],
          true,
        ],
      ],
      [
        [
          [292.9399983081827, 321.04496242335836],
          [301.41124169557446, 297.40574481030876],
          [271.4382902635834, 296.1319728479751],
          [319.88255402047366, 273.7665574434494],
          true,
        ],
        [
          [331.38418270096264, 298.67951674085646],
          [350, 345.76013009266507],
          [271.4382902810318, 296.1319724373992],
          true,
        ],
      ],
      [
        [
          [349.2988989052917, 302.360122358839],
          [306.8847250793194, 310.8417788081535],
          [317.34865046978905, 286.0848942283935],
          [295.03238113332606, 289.30770347326694],
          true,
        ],
        [
          [306.8847250793191, 310.8417788081534],
          [308.40196713650136, 308.29790890842884],
          [297.432392604982, 249.3091944403423],
          [330.2439214313423, 255.57562328972034],
          true,
        ],
      ],
      [
      ...
      [
        [
          ...
          [324.85949771228013, 85.81468459475798],
          [331.26017128225755, 56.500458549069435],
          [349.988176980811, 69.4187741812245, 0, 0, 9.063133638672639, 13.890328297113285],
          true,
        ],
        [
          [318.4609036471463, 115.11938678905685],
          [340.9228398583517, 111.1463404606569],
          [308.7912208820021, 60.47525341924158],
          [331.2601712818937, 56.50045854899],
          true,
        ],
      ],
      [
      ...
      [
        [
          ...
          [553.1321511797777, 344.4081743101702],
          true,
        ],
        [
          ...
          [574.716309478071, 325.5938972523037],
          [553.1321511797779, 344.40817431017007],
          true,
        ],
      ],
      [
        [
          [525, 345],
          [557.3179687742295, 363.04379418599376],
          [587.1223034990716, 366.54087021669767],
          [500, 400],
          true,
        ],
        [
          [527.5311085637297, 359.5487685170587],
          [533.6060904205631, 381.4080959083297],
          [581.0430044030195, 344.66929908778826],
          [587.1223034989287, 366.54087021791537],
          true,
        ],
      ],
      [
        [
          [250, 150],
          [234.74625221124325, 182.05024235296503],
          [205.60227766791786, 189.2546311484904],
          [205.60227766791786, 189.4546311484904],
          [205.61255586021304, 189.25209037995552],
          [263.84900039629053, 174.85604471078497],
          true,
        ],
      ...
      [
        [
          [598.5486959306086, 408.11025390080914],
          [556.2683544908633, 467.2163769525839],
          [552.429221746517, 437.22810161381835],
          true,
        ],
        [
          [556.2683546136653, 467.2163769491477],
          [518.5330018076562, 379.67700053006695],
          [554.5900896267148, 407.2398529865706],
          true,
        ],
      ],
      [
        [
          [570, 290],
          [575.8176000300452, 323.5855681222093],
          [547.6444566349796, 309.1465641549448],
          [578.8341920603752, 304.57835489946484, 0, 0, -5.7225406635552645e-9, -3.907138079739525e-8],
          [519.4675806753132, 313.27349449897866],
          true,
        ],
    ...
    const results = [
      [
        'M240,270l4.48298,-20.84932l-14.48298,0.84932l7.67824,-56.20204l82.32176,46.20204zM237.67824,193.79796z',
        'M244.48298,249.15068l6.05168,-28.14496l12.77751,27.04076z',
      ],
      [
        'M450,230l-87.53067,34.43944l-0.01593,-0.02371h0c-0.91969,-0.32388 -30.35274,-0.48069 -30.67835,2.89141l-2.76789,-52.67014z',
        'M362.46933,264.43944l-0.01593,-0.02371c0.02221,0.00782 0.02779,0.01574 0.01593,0.02371z',
      ],
      [
        'M211.76471,391.55301c-1.13066,-11.28456 3.81977,12.25688 -5.47954,24.76763l-28.00902,-21.41225l-26.21252,2.62636l13.04584,-12.69198l-22.93592,-17.53397l30.159,10.50681l46.32376,-45.06725c-9.58101,10.09791 -8.78302,39.92732 -6.89161,58.80464z',
        'M178.27615,394.90839l-13.16668,-10.06562l7.22309,-7.02716l39.43215,13.7374z',
      ],
      [
        'M138.31417,456.06811c1.62465,-1.18877 -18.69614,16.61617 -34.61033,15.37458l22.34488,-66.7556l-23.16516,-97.04078l209.03396,72.10619c-68.45789,0.5466 -139.96009,51.6986 -173.60335,76.31563z',
        'M126.04871,404.68708l21.5947,-64.51445l-9.32924,115.89547z',
      ],
      [
        'M300.04122,200l-0.02301,55.81328l19.98178,24.18672l-19.98771,-9.82138l-0.01229,29.82138l-29.04124,-44.09743l-40.1367,-19.722z',
        'M300.01822,255.81328l-0.00592,14.36534l-29.05353,-14.27606l-10.39571,-15.78528l29.74019,3.93662z',
      ],
      [
        'M320,240l-17.26682,25.90022l17.26682,34.09978l-27.9401,-18.08984l-12.0599,18.08984l-8.52877,-31.42l-35.04561,-22.69031z',
        'M302.73318,265.90022l-10.67329,16.00993l-20.58867,-13.33015l-5.23726,-19.29408l29.80597,3.39596z',
      ],
      [
        'M157.63421,284.83942l-7.63421,44.55788l-40.73067,-80.07813l47.87749,-25.20588l4.59855,59.82352c-2.48454,0.19098 -3.64723,0.63304 -4.11116,0.90261z',
        'M157.63421,284.83942c-0.00547,0.00318 -0.01083,0.00633 -0.01611,0.00945c0.0062,-0.0081 0.01246,-0.01645 0.01878,-0.02506zM157.61811,284.84887c-0.25231,0.3297 -0.39376,0.23354 0,0z',
      ],
      [
        'M249.53401,269.57063c-5.12674,1.32393 -6.49012,2.86652 -6.50509,2.88317c-0.17123,0.40034 -0.45801,1.48334 -0.35964,3.78705l-45.48004,-42.50042zM243.02893,272.45376c0.00005,-0.00006 0.00012,-0.00014 0.00019,-0.00023l-0.00007,-0.00006c-0.00004,0.0001 -0.00008,0.00019 -0.00012,0.00029z',
        'M243.02891,272.4538c-0.00017,0.00019 -0.00017,0.00018 0.00001,-0.00003c0,0.00001 -0.00001,0.00002 -0.00001,0.00003zM243.02912,272.45353l-0.00007,-0.00006c0.12387,-0.28946 0.18715,-0.22146 0.00007,0.00006z',
      ],
      [
        'M326.35621,259.51658c1.15567,-2.02805 1.46269,-3.25061 1.52678,-3.82669l-7.88299,-5.68989l64.9541,-12.98727l-34.9541,62.98727z',
        'M327.88299,255.68989c0.00623,-0.05602 0.01017,-0.10593 0.01237,-0.14987c0.01299,0.05713 0.03113,0.12366 0.05593,0.19917zM327.89536,255.54001c-0.0732,-0.32201 0.01728,-0.34576 0,0z',
      ],
      [
      ...
      [
        'M534.41418,349.41355c0.99527,-5.06433 -2.16222,25.36794 -15.58857,34.81815l-30.9435,-43.96286l-12.34178,-2.42547l62.78203,-185.64163l38.32358,46.16604c-12.47171,10.35308 -32.36184,100.8236 -42.23175,151.04577z',
        'M534.41418,349.41355l-5.01164,-0.98491c-0.93901,-2.14075 5.01164,0.98491 5.01164,0.98491z',
      ],
      [
      ...
      [
        ...
        'M224.00707,160.33233c-0.22634,0.29111 -0.46281,0.61073 -0.70669,0.96032l-0.39992,0.32276c0.32907,-0.39735 0.69884,-0.82812 1.10661,-1.28308zM226.38122,157.869c0.04659,-0.0292 0.02861,-0.00624 -0.065,0.06289c0.02161,-0.02095 0.04328,-0.04191 0.065,-0.06289z',
      ],
      [
        'M517.50472,202.91542l28.24931,10.08472c0.00241,0.00682 0.00483,0.01365 0.00724,0.02047l-0.00293,-0.01893c0,0 0,0 0,0c0,0 0,0 0,0l-4.59628,-29.64581c-5.58903,0.86652 -0.50164,15.25023 4.58932,29.63676c-0.44214,-0.57333 -21.80103,-28.13268 -28.24666,-10.07721zM545.75834,213.00168l12.08482,-27.45828c-8.32546,-3.66417 -12.08387,27.45042 -12.08482,27.45828c0,0 0,0 0,0zM550.35462,242.64749c5.58313,-0.86561 0.49657,-15.24328 -4.59335,-29.62688z',
        'M545.75403,213.00014l0.00431,0.00154l0,0c-0.00007,-0.00009 -0.00241,-0.00314 -0.00697,-0.00905c0.00089,0.0025 0.00177,0.00501 0.00266,0.00751z',
      ],
      [
        'M290.12533,287.90652l22.75403,-2.60738l27.32709,-33.31167l0,0l30.67517,40.04265l-27.52018,-1.40525l1.72814,21.16356l-45.08133,-10.79944l9.90334,-12.07215z',
        'M312.87936,285.29914l29.76865,-3.41118l0.71343,8.73692l-33.44985,-1.70803z',
      ],
      [
        'M371.53494,257.2226c-5.3407,-1.86741 -9.84549,-0.99074 -11.34052,-0.17407l-0.02947,-0.01324c0.0301,-0.00458 0.04264,0.00337 0.03269,0.01116c0.51449,-0.33235 62.44572,-40.28995 70.21684,-21.8115zM360.16495,257.03529c-0.16487,0.02506 -0.85657,0.42566 -1.2654,3.2836l-58.89955,-30.31889z',
        'M360.19442,257.04853c0,0 0.00108,-0.0007 0.00322,-0.00208c-0.00089,0.0007 -0.00197,0.0014 -0.00322,0.00208z',
      ],
      [
        ...
        'M403.62547,256.25365l-0.01222,-0.01004c0.06335,-0.09382 0.08235,-0.07531 0.01222,0.01004z',
      ],
      [
        'M292.94,321.04496l3.31075,-9.23873l-24.81246,-15.67426l0,0l0,0l0,0l0,0l48.44426,-22.36542l-13.5895,23.84665l25.09113,1.06631l18.61582,47.08061l-52.31238,-33.04622z',
        'M296.25075,311.80623l5.16049,-14.40049l0,0l4.88182,0.20746l-8.60544,15.1007zM301.41124,297.40574l-29.97295,-1.27377l0,0l0,0z',
      ],
      [
        'M349.2989,302.36012l-42.41417,8.48166l1.38218,-3.27015l0,0l-2.93573,-15.78682l-10.2988,-2.47711l9.58086,-1.38362l-7.18085,-38.61489l32.81153,6.26643l-16.1911,38.30696z',
        'M304.61324,287.92408l12.73541,-1.83919l-3.29583,7.79769l-8.72164,-2.09777zM308.40197,308.29791l-1.51724,2.54387l1.38218,-3.27015z',
      ],
      [
        'M150,290l30,-30l50,10l-24,16l14,14l-50,10l21.17647,-14.11765z',
        'M191.17647,295.88235l14.82353,-9.88235l14,14z',
      ],
      [
        'M324.40827,86.1091l-24.66974,16.09646c-4.37001,-6.69756 10.04945,-11.38915 24.66974,-16.09646zM324.40827,86.1091l0.45123,-0.29442l-16.06828,-25.33943l22.46895,-3.97479l18.72801,12.91832c4.53222,6.94617 -10.24683,11.75354 -25.05014,16.51976l15.98481,25.2078l-22.46194,3.97305l6.36357,-29.14428c-0.13874,0.04467 -0.27748,0.08933 -0.4162,0.134z',
        'M324.8595,85.81469l0,0l0,0zM324.93803,85.93854c-0.03785,0.01219 -0.07571,0.02438 -0.11356,0.03656l0.03503,-0.16042z',
      ],
      [
        'M388.92139,223.32159c120.27613,-2.24369 208.69681,19.62691 208.69681,19.62691l0.0116,0.00003l0,0l21.89025,-21.07283c0,0 8.54573,10.72909 8.51542,21.16115c-0.03104,10.68629 -208.75655,121.23392 -208.75655,121.23392z',
        'M576.29425,263.48737l-8.25852,-20.6248l29.59407,0.08596z',
      ],
      [
        ...
        'M274.23395,194.10449l-0.00118,-0.00313c0.01275,-0.00503 0.01337,-0.00299 0.00118,0.00313z',
      ],
      [
        'M386.40934,270.73027c77.4169,15.77719 129.39044,24.64733 142.22581,18.90659l5.47489,12.24096l0,0l40.60627,23.71608l-21.58416,18.81428z',
        'M522.90574,295.33395c2.3982,-4.10616 5.41393,-5.55599 5.72941,-5.69709l5.47489,12.24096z',
      ],
      [
        'M525,345l32.31797,18.04379l23.72504,-18.37449l6.0793,21.87157l-87.1223,33.45913z',
        'M557.31797,363.04379l0,0l0,0zM557.31797,363.04379l-23.71188,18.3643l-6.07498,-21.85933z',
      ],
      [
        'M250,150l-15.25375,32.05024l29.10275,-7.1942zM225.84314,153.10482l-45.84314,36.89518l63.48255,20.45333z',
        'M205.60228,189.25463v0.2l0.01028,-0.20254z',
      ],
      [
        'M598.5487,408.11025l-42.28034,59.10612l0,0l0,0l0,0l0,0l-37.73535,-87.53938l36.05709,27.56285l0.78705,28.12706z',
        'M556.26835,467.21638l0,0l-3.83913,-29.98827l2.94792,-1.86119z',
      ],
      [
        'M570,290l5.8176,33.58557l-28.17314,-14.439c-14.32289,2.0978 -28.17688,4.12693 -28.17688,4.12693l19.08162,-8.78834l-16.12739,-8.26544l27.9654,2.81326z',
        'M538.5492,304.48516l11.83801,-5.45218l9.61279,0.96702l15.8176,23.58557z',
      ],
      ['', ''],
      [
  ...
  it('#1506', function () {
    const path1 = new Path(
      'M250,175c27.61424,0 50,22.38576 50,50c0,27.61424 -22.38576,50 -50,50c-9.10718,0 -17.64567,-2.43486 -25,-6.68911c14.94503,-8.64524 25,-24.80383 25,-43.31089c0,-18.50706 -10.05497,-34.66565 -25,-43.31089c7.35433,-4.25425 15.89282,-6.68911 25,-6.68911z'
    );
    const path2 = new Path(
      'M250,225c0,-27.61424 22.38576,-50 50,-50c27.61424,0 50,22.38576 50,50c0,27.61424 -22.38576,50 -50,50c-27.61424,0 -50,-22.38576 -50,-50z'
    );
    const result =
  ...
  it('#1619', () => {
    ...
    const result =
      'M380,580h-160v-260l180,0v130zM313.36486,413.71682l-70.01386,69.98614l69.98614,70.01386l70.01386,-69.98614z';
    compareBoolean(path1.intersect(path2), result);
  });
});
