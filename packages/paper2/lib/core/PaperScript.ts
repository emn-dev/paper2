...
Base.exports.PaperScript = function () {
  ...
  console.log("asdfasfsadfa----acorn---dfasfasfdaf");
  console.log(acorn);
  // Also try importing an outside version of Acorn.
  //   if (!acorn && typeof require !== "undefined") {
  //     console.log("asdfasfsadfa----acorn---dfasfasfdaf-222222");
  //     try {
  //       acorn = require("acorn");
  //     } catch (e) {
  //       // acorn = null;
  //     }
  //   }
  console.log("asdfasfsadfa----acorn---dfasfasfdaf-3333333");
  console.log(acorn);
  // If no Acorn was found, load the bundled version.
  if (!acorn) {
    console.log("asdfasfsadfasfasfsadfasfdasfsadfasfasfdaf");
